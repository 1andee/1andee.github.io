...
const Skills = () => {
  ...
  const skillList = ['JavaScript', 'React', 'NativeScript', 'Node.js', 'Express.js', 'Postgres', 'Knex.js', 'MongoDB', 'Ruby on Rails', 'HTML5', 'CSS', 'jQuery', 'SQL', 'Heroku', 'Amazon AWS', 'GitHub', 'Bootstrap', 'Wordpress', 'Photoshop']

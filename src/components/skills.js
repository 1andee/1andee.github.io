...
const Skills = () => {
  ...
  const skillList = ['JavaScript', 'React', 'NativeScript', 'Node.js', 'PHP', 'Express.js', 'SQL', 'Postgres', 'MongoDB', 'Ruby on Rails', 'HTML5', 'CSS', 'jQuery', 'SQL', 'Heroku', 'GitHub', 'Bootstrap', 'Wordpress', 'Photoshop']
